/// \file QnCorrectionsProfileChannelizedIngress.cxx
...
namespace Qn {
/// Default constructor
CorrectionProfileChannelizedIngress::CorrectionProfileChannelizedIngress() : CorrectionHistogramBase() {
}
...
Bool_t CorrectionProfileChannelizedIngress::AttachHistograms(TList *histogramList,
  ...
  if (origEntries && origEntries->GetEntries() != 0) {
    ...
    fValidated = new THnC(Form("%s_Validated", (const char *) histoName),
                          Form("%s_Validated", (const char *) histoName),
                          nVariables + 1,
                          nbins,
                          minvals,
                          maxvals);
